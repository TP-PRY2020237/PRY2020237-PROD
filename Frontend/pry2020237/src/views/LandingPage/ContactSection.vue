<template>
  <section class="pb-8" id="contact">
    ...
    <div class="svg-border-waves text-white">
      <v-img src="~@/img/borderWavesBlue.svg"/>
    </div>
    <v-snackbar
...
export default {
  data: () => ({
    ...
    nameRules: [
      ...
      (v) => (v && v.length >= 6) || "No ingresar un nopmbre mayor a 6 caracteres",
    ],
    email: "",
    emailRules: [
    ...
    textArea: "",
    textAreaRules: [
      (v) => !!v || "El campo de comentario es obligatorio",
